"""
Django settings for the_test_app_1 project.
...
ROOT_URLCONF = 'the_test_app_1.urls'
...
WSGI_APPLICATION = 'the_test_app_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "the_test_app_1 API",
    "DESCRIPTION": "API documentation for the_test_app_1 App",
    "VERSION": "v1",
}
